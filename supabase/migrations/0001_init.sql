...
create table stammdaten (
  ...
  name text not null default 'Markus Kriesmair',
  adresse text not null default 'Spicherenstraße 3
81667 München',
  strasse text not null default 'Spicherenstraße 3',
  plz text not null default '81667',
  ort text not null default 'München',
  land text not null default 'DE',
  website text not null default 'mkriesmair.online',
  telefon text not null default '',
  email text not null default '',
  steuernummer text not null default '145 150 71 238',
  ust_id_nr text not null default '',
  iban text not null default 'DE30100110012847846718',
  bic text not null default '',
  bank text not null default 'N26',
